...
class DiscordInterfaceSystem:
    ...
    def __init__(self):
        ...
        self.data_feed_channel_id = self.agents_config.get('data_feed_channel_id')
    ...
    def load_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            config = {
                ...
                "data_feed_channel_id": get_vault_secret('DISCORD_DATA_FEED_CHANNEL_ID') or None,
        ...
        for agent_key, interface_config in self.agents_config['agents'].items():
            try:
                ...
                if agent_instance:
                    ...
                    interface_config['data_feed_channel_id'] = self.data_feed_channel_id
