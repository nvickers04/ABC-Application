...
- Historical data series for backtesting
- Options chains and Greeks calculations
- Company fundamentals and financial metrics
- Technical indicators (RSI, MACD, moving averages)

### MarketDataAppDatasub
**Role**: Premium real-time trading data and market depth
**Capabilities**:
- High-quality real-time quotes and trades
...
**Role**: Market microstructure and order flow analysis
**Capabilities**:
- Bid/ask spread analysis
- Trade classification (algorithmic vs. human)
- Liquidity assessment and impact costs
...
### FundamentalDatasub
**Role**: Company financial analysis and valuation
**Capabilities**:
...
**Role**: Institutional holdings and flow analysis
**Capabilities**:
...
### KalshiDatasub
**Role**: Prediction market data and event contracts
**Capabilities**:
- Political and economic event predictions
...
- Dynamic hedging and Greeks management
...
- Thematic and sector rotation plays
- Complex multi-instrument positioning
